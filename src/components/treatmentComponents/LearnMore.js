    ...
    <div className="container">
      <div className="row">
        <div className="col-12">
          <h1 className="TreatmentLearnMore">Learn more about your condition</h1>
        </div>
            ...
            <div className="col-12 ">
              <div className="card">
                <img
                  ...
                  width={"80px"}
                />
                <h3 className="px-1 ms-3 px-lg-5 TreatmentCardTitle">Causes</h3>
                ...
                <div className="d-flex">
                  <p className="px-1 px-lg-5 mb-4 ms-3 TreatmentCardLearnMore">
            ...
            <div className="col-12 ">
              <div className="card">
                <img
                  ...
                  width={"80px"}
                />
                <h3 className="px-1 ms-3 px-lg-5 TreatmentCardTitle">Symptoms</h3>
