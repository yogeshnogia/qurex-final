      ...
      if (navigator.onLine) {
        const response = await put(
          BaseSetting.adminApiDomain +
            `/treatment/updateTreatment/${editData._id}`,
          inputs,
          headers
        );
  ...
  const deleteData = async (id) => {
    try {
      if (navigator.onLine) {
        await axios
          .delete(
            BaseSetting.adminApiDomain + `/treatment/removeTreatment/${id}`,
            { headers }
          )
          .then(() => {
            getData();
  ...
  return (
    <div className="flex flex-col px-10 font-montserrat">
      <div className="py-6 font-semibold text-2xl text-[#636363]">
        Treatments Provided by Doctors
      </div>
      <div className="flex flex-row">
                    ...
                    <div className="relative flex-auto p-3">
                      <div className="grid grid-cols-2 gap-5 p-6 leading-relaxed">
                        <div className="flex flex-col ">
                          ...
                          <div className="flex flex-row">
                            <textarea
                              className="min-h-[90px] w-full border px-1 rounded outline-none font-montserrat font-normal text-gray-400 text-[12px]"
                              placeholder="Please provide treatment description"
                              name="description"
                              value={
                          ...
                          <div className="mt-1 flex flex-row">
                            <div className="flex flex-row">
                              ...
                              <div className="text-sm text-[#626262] mt-[1px] ml-1 ">
                                Male
                              </div>
                            </div>
