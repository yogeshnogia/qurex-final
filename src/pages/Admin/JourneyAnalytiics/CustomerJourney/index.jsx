...
const Logs = () => {
  ...
  const columns = [
    ...
    {
      name: 'Latest Visited Date Time',
      selector: (row) => row.latestvisiteddatetime,
    },
    {
      name: 'User Id',
  ...
  return (
    <div className="font-montserrat flex flex-col px-10">
      <div className="py-6 font-semibold text-2xl text-[#636363]">Logs</div>
